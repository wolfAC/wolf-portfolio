...
import { AUTHOR_NAME, REPO_URL } from './constants.js'

const text = `
${AUTHOR_NAME.toUpperCase()}'S PORTFOLIO
...
╔═ Musics ══════════════╗
║ The music you hear was originally commissioned for this portfolio template by the awesome Kounine (Linktree).
║ https://linktr.ee/Kounine
║ They are now under CC0 license, meaning you can do whatever you want with them!
║ Download them here.
║ ${REPO_URL}/tree/main/static/sounds/musics
╚═══════════════════════╝
